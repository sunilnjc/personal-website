...
export const metadata: Metadata = {
  ...
  description: 'A personal collection of projects, milestones, and notes by Sunil. Explore applications in AI, learning, finance, media production, and backend systems.',
